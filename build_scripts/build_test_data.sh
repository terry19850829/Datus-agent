...
run_bootstrap_kb bootstrap-kb --config tests/conf/agent.yml --datasource bird_school --kb_update_strategy overwrite --components ext_knowledge --ext_knowledge datus/sample_data/california_schools/ext_knowledge.csv --yes
